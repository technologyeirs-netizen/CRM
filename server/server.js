...
app.use('/api/converted-quotations', require('./routes/convertedQuotationRoutes'));
app.use('/api/sales-quotations', require('./routes/salesQuotationRoutes'));
...
app.use('/api/fsm/leaves', require('./routes/fsmLeaveRoutes'));
